...
public class CuredZombiePigTrigger extends AbstractCriterionTrigger<CuredZombiePigTrigger.Instance> {
    private static final ResourceLocation ID = ZombieVeterinarianMod.prefix("cured_zombie_pig");
    @Override
    public ResourceLocation getId() {
        return ID;
    }

    public CuredZombiePigTrigger.Instance createInstance(JsonObject p_230241_1_, EntityPredicate.AndPredicate p_230241_2_, ConditionArrayParser p_230241_3_) {
        ...
        return new CuredZombiePigTrigger.Instance(p_230241_2_, entitypredicate$andpredicate, entitypredicate$andpredicate1);
    }
    ...
    public static class Instance extends CriterionInstance {
        ...
        public Instance(EntityPredicate.AndPredicate p_i231535_1_, EntityPredicate.AndPredicate p_i231535_2_, EntityPredicate.AndPredicate p_i231535_3_) {
            super(CuredZombiePigTrigger.ID, p_i231535_1_);
